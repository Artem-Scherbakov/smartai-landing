...
export default function Cases() {
  ...
  return (
    <section id="cases" className="border-b border-ink-700 bg-ink-950">
      <div className="mx-auto max-w-6xl px-5 py-20">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {t.cases_items.map((c, i) => (
            <div key={c.t} className="rounded-xl border border-ink-700 bg-ink-900 p-6 transition hover:border-ink-600 hover:bg-ink-800">
